...
class picture
{
    ...
    static function code($text, $len = "4", $width = 70, $height = 30)
    {
        ...
        for ($i = 0 ; $i < $len ; $i++)
        {
            imagettftext($img, rand(15, 32), rand(-30, 30), 15 * $i + 3, rand(18, $height - 18) + 10, $color[rand(0, 2)], __DIR__ . '/fonts/lucida.ttf', $text[$i]);
        }
        ...
        //绘制线条、矩形框
        image::draw($img, $color[rand(0, 2)], array(
    ...
    ))
    {
        ...
        imagettftext($image, 9, 0, $img_width - 145, $img_height - 14, $text_color, __DIR__ . '/fonts/lucida.ttf', $mark[0]);
